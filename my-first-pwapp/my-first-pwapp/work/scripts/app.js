...
(function() {
  'use strict';
  //添加一个对象，app，给他设置若干属性，这些属性的类型可以是boolean可以是object。
  //也是一种设计模型了。
  var app = {
    isLoading: true,
    visibleCards: {},
  ...
  document.getElementById('butAddCity').addEventListener('click', function() {
    ...
    app.saveSelectedCities(); //在这里调用保存数据到localstorage的功能
  ...
  // 在实际测试中也确实发现，使用localstorage，会出现一点卡顿。有阻塞。
  //保存用户选择的城市 
  ...
  //添加一些启动代码来检查用户是否已经订阅了某些城市，并渲染它们，
  //或者使用插入的天气数据来渲染。从代码中寻找以下的TODO注解：
...
if (app.selectedCities) {
  ...
  //因为本质上navigator也是一个对象，在这里使用了js里面操作对象的in方法
